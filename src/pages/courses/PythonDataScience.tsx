...
const PythonDataScience = () => {
  ...
  const videos: Video[] = [
    ...
    },
    {
      ...
      duration: "22:45",
      thumbnail: "/thumbnails/numpy-pandas.jpg",
      completed: false,
      locked: false
    },
    {
      ...
      duration: "20:20",
      thumbnail: "/thumbnails/matplotlib.jpg",
      completed: false,
      locked: true
    },
    {
    ...
    },
    {
      ...
      duration: "23:10",
      thumbnail: "/thumbnails/data-projects.jpg",
      completed: false,
      locked: true
    }
  ];
  ...
  const quizzes: Quiz[] = [
    ...
    {
      question: "Which of these is a key feature of Pandas?",
      options: [
        "Game development",
        "Image processing",
      ...
      >
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-start">
            <div>
              <h1 className="text-4xl font-bold text-emerald-400">Python for Data Science</h1>
              <p className="text-zinc-400 mt-2">Master data analysis and visualization with Python</p>
            </div>
                  ...
                  {!quizCompleted ? (
                    <div className="space-y-6">
                      <div className="flex items-center justify-between">
                        <h2 className="text-2xl font-bold text-emerald-400">Python Challenge</h2>
