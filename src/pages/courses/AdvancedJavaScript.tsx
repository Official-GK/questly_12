  ...
  const videos: Video[] = [
    {
      ...
      duration: "18:30",
      thumbnail: "/thumbnails/js-advanced.jpg",
      completed: true,
      locked: false
    },
    {
      ...
      duration: "22:45",
      thumbnail: "/thumbnails/closures.jpg",
      completed: false,
      locked: false
    },
    {
      ...
      duration: "20:20",
      thumbnail: "/thumbnails/prototypes.jpg",
      completed: false,
      locked: true
    },
    {
  ...
  const quizzes: Quiz[] = [
    ...
    },
    {
      ...
      options: [
        ...
        "A way to chain multiple API calls"
      ],
      correctAnswer: 2
    },
    {
      ...
      options: [
        "Creating new events",
        "The process where an event triggers on innermost element and propagates outward",
        "A way to debug events",
      ...
      >
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-start">
            <div>
              <h1 className="text-4xl font-bold text-emerald-400">Advanced JavaScript</h1>
              <p className="text-zinc-400 mt-2">Master advanced concepts and patterns in JavaScript</p>
            </div>
                  ...
                  {!quizCompleted ? (
                    <div className="space-y-6">
                      <div className="flex items-center justify-between">
                        <h2 className="text-2xl font-bold text-emerald-400">JavaScript Challenge</h2>
